...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/diowa/ruby2-rails4-bootstrap-heroku/blob/master/app.json)
